...
use App\Http\Requests\v2\Assessments\PreCoachingPamIndexRequest;
use App\Http\Requests\v2\Assessments\UpdatePreCoachingPamRequest;
use App\Models\v2\Assessments\PreCoachingPam;
use Illuminate\Http\Request;

class PreCoachingPamController extends Controller
{
    public function index(PreCoachingPamIndexRequest $request)
    {
    ...
    public function update(UpdatePreCoachingPamRequest $request)
    {
